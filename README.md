...
![SQL](./images/5b.jpg) 
The chart clearly indicates that Office Supplies are the most heavily discounted items, followed by Furniture and Technology. In the subsequent steps, we will explore the profit and sales generated by each category. Next, let's take a closer look at the categories to identify which specific products receive the highest discounts.
